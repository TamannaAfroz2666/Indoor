...
import { Bookmark, CalendarDays, CircleUserRound, ClipboardList, Gamepad2, LogOut, Settings, Store, Users } from "lucide-react";
...
const items = [
  ...
  { label: "Booking Requests", href: "/owner/bookings", icon: ClipboardList },
